...
public abstract class QueryHolder
{
    ...
    protected static void loadQueries(String filename, String queryIdPrefix, String queryIdPostfix)
    {
    ...
    protected static String actualFileName(String filename)
    {
    ...
    protected static String getSql(String sqlfilename, String tag)
    {
